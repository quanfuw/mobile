...
public class BookStore extends FragmentActivity implements ActionBar.TabListener {
    ...
    public void onTabSelected(ActionBar.Tab tab, FragmentTransaction fragmentTransaction) {
		...
		case 0:values = new String[] { "Android", "iPhone", "WindowsMobile",
		          "Blackberry", "WebOS", "Ubuntu", "Windows7", "Max OS X",
		          "Linux", "OS/2" };
		case 1:  values = new String[]{"Activity","Document", "Gadget Appllication"};
		case 2:	values = new String[] { "Social", "Collaboration", "Knowledge",
		          "DMS", "WCM", "PLF", "Intranet"};
		default: 
			break;
		}    
        listdata = new ArrayAdapter<String>(this, android.R.layout.activity_list_item, android.R.id.text1, values);
