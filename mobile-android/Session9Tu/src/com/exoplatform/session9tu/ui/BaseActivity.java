...
/**
 * share common ui parts to all activities including action bar
 * 
  ...
  public boolean onOptionsItemSelected(MenuItem menuItem)
  {
    switch (menuItem.getItemId()) {
      ...
      case R.id.addBook: 
        ...
        break;
      case R.id.bookSettings:
        Intent bookSettings = new Intent();
        bookSettings.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        bookSettings.setAction(BookConstant.BOOK_SETTINGS_INTENT);
        startActivity(bookSettings);
        break;
    }
    return true;
  }
