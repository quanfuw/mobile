 ...
 */
package com.exoplatform.session9tu.util;
...
public class BookConstant 
{
  ...
  public static final String PACKAGE_NAME         = "com.exoplatform.session9tu";
  ...
  public static final String BOOK_SETTINGS_INTENT = PACKAGE_NAME + ".intent.BookSetting";
